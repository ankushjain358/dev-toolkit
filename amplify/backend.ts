...
const s3Bucket = s3.Bucket.fromBucketArn(customStack, 'app-bucket', backend.storage.resources.bucket.bucketArn)

// For defaultBehavior, uses a dummy origin that will return errors for any request not matching /public/*
const distribution = new cloudfront.Distribution(customStack, "CloudFrontDistribution", {
    defaultBehavior: {
